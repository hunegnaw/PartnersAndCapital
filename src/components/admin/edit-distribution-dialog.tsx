...
export function EditDistributionDialog({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const res = await fetch(`/api/admin/distributions/${distribution.id}`, {
        method: "PATCH",
      ...
      <DialogContent className="sm:max-w-md">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Update the distribution record details.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              <Label htmlFor="edit-dist-amount">Amount *</Label>
              <Input
                id="edit-dist-amount"
                type="number"
                step="0.01"
            ...
            <div className="grid gap-2">
              <Label htmlFor="edit-dist-time">Time</Label>
              <Input
                id="edit-dist-time"
                type="time"
                value={time}
            ...
            <div className="grid gap-2">
              <Label htmlFor="edit-dist-description">Notes</Label>
              <Textarea
                id="edit-dist-description"
                value={description}
