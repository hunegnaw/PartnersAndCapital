  ...
  return (
    <div className="p-8 space-y-8">
      ...
      <nav className="flex items-center gap-2 text-sm text-[#888780]">
        ...
        <span>/</span>
        <span className="text-[#1a1a18]">{data.client.name}</span>
      </nav>
      ...
      <div>
        ...
        {data.client.company && (
          <p className="text-sm text-[#888780] mt-0.5">{data.client.company}</p>
        )}
        <div className="mt-2">
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {data.investments.map((inv) => (
                  <tr
                    key={inv.id}
                    className="border-b border-[#eeece8] last:border-0"
                  >
                    <td className="py-3 font-medium text-[#1a1a18]">
                      {inv.name}
                    </td>
