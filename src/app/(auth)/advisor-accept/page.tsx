...
export default function AdvisorAcceptPage() {
  ...
  return (
    <div className="rounded-lg border border-[#e8e0d4] bg-white p-8 shadow-sm">
      ...
      {/* Invitation details */}
      <div className="mb-6 rounded-md border border-[#e8e0d4] bg-[#faf8f5] p-4">
        <div className="flex items-start gap-3">
          <UserPlus className="h-5 w-5 text-[#b8860b] mt-0.5 shrink-0" />
          ...
          <>
            ...
            <div>
              ...
              <input
                ...
                disabled
                className="w-full rounded-md border border-[#e8e0d4] bg-gray-50 px-3 py-2 text-sm text-muted-foreground"
              />
            </div>
